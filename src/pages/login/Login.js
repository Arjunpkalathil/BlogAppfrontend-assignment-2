...
return <Loading/>
  ...
  return <section className='loginContainer'>
      <div className='loginArticle'>
          ...
          <p style={{color:'#41bbe7',fontStyle:'italic'}}>{error.email}</p>
          </div>
          ...
          <p style={{color:'#41bbe7',fontStyle:'italic'}}>{error.password}</p>
         
          </div>
        <button className='LoginBtn' type='submit'>Login</button>
        <p style={{color:'#41bbe7',textAlign:'center',marginTop:'5px'}}>{apiMsg.apiFail}</p>
      </form>
      </div>
      <Link to={'/register'}>
